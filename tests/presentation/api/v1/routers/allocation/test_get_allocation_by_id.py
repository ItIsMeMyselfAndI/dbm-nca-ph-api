def test_get_allocation_by_id(client):
    ...
    assert data["nca_number"] == "NCA-ROIVB-25-0000114"
    assert data["agency"] == ""
    assert data["operating_unit"] == "Coron School of Fisheries"
    assert data["amount"] == 13209000
...
def test_get_allocation_by_id_case_sensitivity(client):
