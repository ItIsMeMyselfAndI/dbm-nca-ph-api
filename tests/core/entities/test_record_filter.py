...
def test_record_filter():
    ...
    assert RecordFilter.NCA_NUMBER.value == "nca_number"
...
def test_record_filter_enum():
    ...
    assert isinstance(RecordFilter.NCA_NUMBER, RecordFilter)
...
def test_record_filter_enum_values():
    ...
    assert RecordFilter("nca_number") == RecordFilter.NCA_NUMBER
...
def test_record_filter_enum_members():
    ...
    assert RecordFilter.NCA_NUMBER in members
...
def test_record_filter_enum_str():
    ...
    assert str(RecordFilter.NCA_NUMBER) == "RecordFilter.NCA_NUMBER"
...
def test_record_filter_enum_comparison():
    ...
    assert RecordFilter.DEPARTMENT != RecordFilter.NCA_NUMBER
    assert RecordFilter.NCA_TYPE != RecordFilter.RELEASE_ID
    assert RecordFilter.NCA_TYPE != RecordFilter.RELEASED_DATE
    assert RecordFilter.NCA_TYPE != RecordFilter.NCA_NUMBER
    assert RecordFilter.RELEASE_ID != RecordFilter.RELEASED_DATE
    assert RecordFilter.RELEASE_ID != RecordFilter.NCA_NUMBER
    assert RecordFilter.RELEASED_DATE != RecordFilter.NCA_NUMBER
...
def test_record_filter_enum_name():
    ...
    assert RecordFilter.NCA_NUMBER.name == "NCA_NUMBER"
